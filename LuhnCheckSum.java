//This program returns the luhn check sum value that is produced when checking credit card numbers
...
//This method returns an integer value which is checksum of an array of integers. The paramater int[] x is the values of the credit card. 
