...
// You can see a video showing the animation of the game here:
...
public class Hanoi {
  ...
  public static void hanoi(int n, String source, String target, String temp) {
    if (n == 1){ //base case
      ...
      //3: move n-1 discs from temp to target, using source as your new accesilery
